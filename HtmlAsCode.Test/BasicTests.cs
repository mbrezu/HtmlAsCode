...
public class BasicTests
{
    ...
    public void WithAttributes()
    {
        var html = H("html",
            ...
            H("head",
                H("title", "Test Title"),
                H("script", A("src", "script.js"))),
            H("body"));
        html.Render().Should().Be("<!DOCTYPE html><html lang=\"en\"><head><title>Test Title</title><script src=\"script.js\"></script></head><body></body></html>");
    }
    ...
    public void WithFragment()
    {
        ...
        html.Render(false).Should().Be("<div><span>Hello, World</span><span>Another World</span></div>");
    }
}
